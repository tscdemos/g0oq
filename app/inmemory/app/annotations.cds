...
annotate filamentManagementSrv.Filament with @odata.draft.enabled;
...
annotate filamentManagementSrv.Filament with @cds.odata.valuelist;
annotate filamentManagementSrv.Filament with @UI.HeaderInfo: { TypeName: 'Filament', TypeNamePlural: 'Filaments', Title: { Value: purchaseDate } };
annotate filamentManagementSrv.Filament with {
  ID @Common.Text: { $value: purchaseDate, ![@UI.TextArrangement]: #TextOnly }
};
annotate filamentManagementSrv.Filament with @UI.Identification: [{ Value: purchaseDate }];
annotate filamentManagementSrv.Filament with {
...
annotate filamentManagementSrv.Filament with @UI.LineItem: [
...
annotate filamentManagementSrv.Filament with @UI.FieldGroup #Main: {
...
annotate filamentManagementSrv.Filament with {
  ...
  materialType @Common.Text: { $value: materialType.type, ![@UI.TextArrangement]: #TextOnly };
  color @Common.Text: { $value: color.colorName, ![@UI.TextArrangement]: #TextOnly }
};

annotate filamentManagementSrv.Filament with @UI.Facets: [
...
annotate filamentManagementSrv.MaterialType with @UI.HeaderInfo: { TypeName: 'Material Type', TypeNamePlural: 'Material Types', Title: { Value: type } };
annotate filamentManagementSrv.MaterialType with {
  ID @Common.Text: { $value: type, ![@UI.TextArrangement]: #TextOnly }
};
annotate filamentManagementSrv.MaterialType with @UI.Identification: [{ Value: type }];
annotate filamentManagementSrv.MaterialType with {
  type @title: 'Type'
};
